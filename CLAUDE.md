# ai-trends — CLAUDE.md
*Last updated: 2026-05-13 · Owner: Dean Kuhn*

---

## A · What this folder is
Trend analysis dashboard for surfacing emerging AI trends from multiple sources. Built for a JAX school community competition. Stage: `idea`.

## B · The Goal
- **Why it exists:** JAX school community competition — build a dashboard that displays AI trends
- **Done looks like:** A live dashboard deployed and demo-ready for competition judging
- **Out of scope:** TBD
...
## G · Project-specific overrides *(optional)*
